...
function GreekGame() {
    ...
    const renderQuestion = () => {
        ...
        return (
            <div className="greek-question-container">
                <h2>{question.question_text}</h2>
                <div className="greek-answer-options">
    ...
    return (
        <div className="greek-game-container">
            <h1>Greek Mythology</h1>
            {gameState === 'countdown' && <div className="greek-countdown">{countdown}</div>}
            {gameState === 'playing' && (
                <>
                    <div className="greek-game-stats">
                        <span>Score: {score}</span>
                        <span>Time left: {timeLeft}s</span>
                    </div>
                    {questions.length > 0 ? renderQuestion() : <p>Loading questions...</p>}
                    {/* <div className="greek-power-ups">
